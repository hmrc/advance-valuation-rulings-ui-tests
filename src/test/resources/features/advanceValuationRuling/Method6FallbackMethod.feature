...
Feature: Journeys for Method 6 which is Fallback method
  ...
  Scenario Outline: Agent on behalf of trader selects Method 6 all pages
    ...
    Then I will be navigated to the Application Complete page
    Examples:
      | EORINo           | EORIType  | AffinityGroup  | CredentialRole |
      | "GB113888888041" | "public"  | "Organisation" | "Assistant"    |
      | "GB112888888041" | "private" | "Organisation" | "User"         |
      | "GB113888888041" | "public"  | "Agent"        | "User"         |
      | "GB113888888041" | "public"  | "Agent"        | "Assistant"    |