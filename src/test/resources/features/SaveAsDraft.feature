...
Feature: Save as draft functionality for all text pages in the application journeys
  ...
  Scenario: Save as draft functionality check as Individual User End To End Journey for Method 1
    ...
    And I enter "description" in Describe how the parties are related
    And I click on Save as draft button
    And I am on Save as draft page and I click on your applications and rulings link
    ...
    And I enter "restrictions" in Describe any restrictions on the use or resale of goods
    And I click on Save as draft button
    And I am on Save as draft page and I click on your applications and rulings link
    ...
    And I enter "various conditions" as the conditions which cannot be calculated
    And I click on Save as draft button
    And I am on Save as draft page and I click on your applications and rulings link
    ...
    And I enter "spices" as the description
    And I click on Save as draft button
    And I am on Save as draft page and I click on your applications and rulings link
    ...
    And I enter "1234" commodity code
    And I click on Save as draft button
    And I am on Save as draft page and I click on your applications and rulings link
    ...
    And I enter "legal challenges" in describe legal challenges page
    And I click on Save as draft button
    And I am on Save as draft page and I click on your applications and rulings link
    ...
    And I enter "confidential information" in describe confidential information page
    And I click on Save as draft button
    And I am on Save as draft page and I click on your applications and rulings link
