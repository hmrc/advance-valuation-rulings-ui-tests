...
class Method3TransactionValueOfSimilarGoodsSpec extends BaseSpec with BeforeAndAfterAll {
  ...
  Feature("Method 3 flows which is based on Transaction value of similar goods") {
    ...
    Scenario("Employee of the org selects Method 3 which is based on Transaction value of similar goods", AllTests) {
      ...
      And("I select Method 3 and continue in Select the method page")
        andISelectMethodIntAndContinueInSelectTheMethodPage(3)

      Then("I will be navigated to Explain Why not select method one or two")
        thenIWillBeNavigatedToExplainWhyNotSelectMethodOneOrTwo()
      ...
      And("I enter a reason and continue in Explain why not method one or two page")
        andIEnterAReasonAndContinueInExplainWhyNotMethodOneOrTwoPage()
        // --- Other possible matches ---
      ...
      And("I select Yes and continue in Have You Used Method One In the Past 90 days")
        andISelectBooleanValueAndContinueInHaveYouUsedMethodOneInThePast90Days(true)

      Then("I will be navigated to Describe the Similar Goods page")
        thenIWillBeNavigatedToDescribeTheSimilarGoodsPage()
        // --- Other possible matches ---
      ...
      And("I enter a reason and continue in Describe the Similar Goods page")
        andIEnterAReasonAndContinueInDescribeTheSimilarGoodsPage()
    ...
    Scenario("Employee of org selects Method 3: Have not used Method 1 to import similar goods in past", AllTests) {
      ...
      And("I select No and continue in Have You Used Method One In the Past 90 days")
        andISelectBooleanValueAndContinueInHaveYouUsedMethodOneInThePast90Days(false)
